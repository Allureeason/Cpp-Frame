...
class NotifyMessage final :
 ...
 public:
  ...
  explicit constexpr NotifyMessage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void RegisterInfo::set_allocated_node(::sylar::ns::Node* node) {
  ...
  if (node) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::sylar::ns::Node>::GetOwningArena(node);
